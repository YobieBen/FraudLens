...
class GmailIMAPScanner:
    ...
    def search_emails(self, query: str = "ALL", folder: str = "INBOX", max_results: int = 1000, offset: int = 0) -> List[str]:
        """
    ...
    async def scan_for_fraud(self, query: str = "UNSEEN", max_emails: int = 1000, offset: int = 0) -> List[Dict]:
        """
        ...
        try:
            ...
            logger.info(f"Found {len(email_ids)} emails to scan (batch starting at offset {offset})")
