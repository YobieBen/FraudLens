...
class CacheManager:
    ...
    def __init__(self):
        ...
        self.memory_cache = InMemoryCache(
            max_size=CacheConfig.MAX_MEMORY_ITEMS,
            default_ttl=CacheConfig.MEMORY_TTL
        )
    ...
    def _init_redis(self):
        ...
        try:
            ...
            logger.info(f"Redis cache connected at {CacheConfig.REDIS_HOST}:{CacheConfig.REDIS_PORT}")
