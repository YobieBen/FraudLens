...
class EnvironmentConfig(BaseSettings):
    ...
    @validator("debug", "smtp_use_tls", "prometheus_enabled", "enable_email_scanning", 
               "enable_video_analysis", "enable_document_validation", 
               "enable_batch_processing", "enable_real_time_monitoring", "use_gpu", pre=True)
