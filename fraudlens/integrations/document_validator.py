...
class DocumentValidator:
    ...
    def _init_passport_rules(self):
        ...
        self.mrz_formats = {
            "TD1": {"lines": 3, "line_length": 30, "check_digits": [14, 21, 28, 29]},  # ID cards
            "TD2": {"lines": 2, "line_length": 36, "check_digits": [19, 27, 35]},  # ID cards, visas
            "TD3": {"lines": 2, "line_length": 44, "check_digits": [9, 19, 42, 43]},  # Passports
        }
    ...
    def validate_ssn(self, ssn: str, country: str = "US") -> Dict[str, Any]:
        ...
        if country not in self.ssn_formats:
            return {"valid": False, "error": f"Unknown country code: {country}", "country": country}
        ...
        return {"valid": True, "country": country, "type": format_info["description"]}
    ...
    def _validate_canadian_sin(self, sin: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "CA", "type": "Social Insurance Number"}
    ...
    def _validate_uk_nino(self, nino: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "UK", "type": "National Insurance Number"}
    ...
    def _validate_swedish_personnummer(self, pnr: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "SE", "type": "Personal Number"}
    ...
    def _validate_french_insee(self, insee: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "FR", "type": "INSEE Number"}
    ...
    def _validate_german_steuerid(self, steuerid: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "DE", "type": "Tax ID"}
    ...
    def _validate_indian_aadhaar(self, aadhaar: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "IN", "type": "Aadhaar Number"}
    ...
    def _validate_australian_tfn(self, tfn: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "AU", "type": "Tax File Number"}
    ...
    def _validate_brazilian_cpf(self, cpf: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "BR", "type": "CPF"}
    ...
    def _validate_spanish_nie(self, nie: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "country": "ES", "type": "NIE"}
    ...
    def validate_driver_license(self, license_number: str, state: str) -> Dict[str, Any]:
        ...
        if state not in self.dl_formats:
            return {"valid": False, "error": f"Unknown state: {state}", "state": state}
    ...
    def validate_passport_mrz(self, mrz_lines: List[str]) -> Dict[str, Any]:
        ...
        if mrz_type == "TD3":  # Passport
            ...
            # Validate check digits
            checks_valid = (
                self._mrz_check_digit(document_number) == document_check
                and self._mrz_check_digit(birth_date) == birth_check
                and self._mrz_check_digit(expiry_date) == expiry_check
            )

            # Validate country code
            if country not in self.valid_country_codes:
                return {"valid": False, "error": f"Invalid country code: {country}"}
        ...
        return {"valid": False, "error": f"MRZ type {mrz_type} not fully implemented"}
    ...
    def validate_credit_card(self, card_number: str) -> Dict[str, Any]:
        ...
        return {"valid": True, "type": card_type, "masked": f"****{clean_number[-4:]}"}
        ...
        for format_key, format_info in self.national_id_formats.items():
            if re.match(format_info["format"], document_data):
                if "validator" in format_info:
                    ...
                    return {"valid": True, "type": format_info["description"]}

        return {"valid": False, "error": f"Unknown document type: {document_type}"}
