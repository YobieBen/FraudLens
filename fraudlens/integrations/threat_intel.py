...
class ThreatIntelligenceManager:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                if feed_name == "urlhaus":
                    ...
                    async with session.post(
                        feed_config["url"] + "urls/recent/", data=data
                    ) as response:
    ...
    async def check_hash(self, file_hash: str) -> Dict[str, Any]:
        ...
        return {"hash": file_hash, "malicious": False, "threat_score": 0.0, "source": "no_match"}
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "feeds_active": len(
                [f for f in self.feeds_status.values() if f.get("status") == "active"]
            ),
