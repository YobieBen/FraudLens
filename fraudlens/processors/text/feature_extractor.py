...
class FeatureExtractor:
    ...
    def __init__(self):
        ...
        self.financial_entities = {
            "bank_names": [
                ...
                "capital one", "pnc", "us bank", "truist", "goldman sachs",
                "morgan stanley", "jpmorgan", "hsbc", "barclays"
            ],
            "payment_services": [
                "paypal", "venmo", "zelle", "cashapp", "stripe",
                "square", "western union", "moneygram", "wise"
            ],
            "credit_cards": [
            ...
            "cryptocurrencies": [
                ...
                "blockchain", "wallet address", "coinbase", "binance"
            ]
        }
        
        # Financial terms
        self.financial_terms = [
            "account", "balance", "transfer", "transaction", "payment",
            "deposit", "withdrawal", "credit", "debit", "loan",
            "mortgage", "interest", "fee", "charge", "refund",
            "invoice", "statement", "routing number", "swift",
            "iban", "wire transfer", "ach", "direct deposit"
        ]
        
        # Urgency indicators
        self.urgency_words = [
            "urgent", "immediate", "asap", "now", "quickly",
            "hurry", "fast", "expire", "deadline", "limited",
            "final", "last chance", "act now", "don't wait"
        ]
    ...
    async def extract_features(self, text: str) -> Dict[str, Any]:
        ...
        features["has_financial_terms"] = features["financial_term_density"] > 0.02  # Lowered threshold for invoices
    ...
    def _analyze_sentiment(self, text: str) -> str:
        ...
        positive_words = [
            ...
            "reward", "refund", "approved", "eligible", "qualified"
        ]
        
        negative_words = [
            "suspended", "blocked", "locked", "frozen", "terminated",
            "expired", "overdue", "penalty", "fine", "violation"
        ]
        
        neutral_words = [
            "update", "verify", "confirm", "review", "check"
        ]
