...
class OCREngine:
    ...
    def __init__(self, use_gpu: bool = False, lang: List[str] = None):
        ...
        logger.info(
            f"OCREngine initialized (PaddleOCR: {self.has_paddle}, Tesseract: {self.has_tesseract})"
        )
    ...
    async def _extract_tesseract(self, image: np.ndarray) -> Dict[str, Any]:
        ...
        try:
            ...
            data = self.pytesseract.image_to_data(
                pil_image, output_type=self.pytesseract.Output.DICT
            )
            ...
            "lines": [
                {
                    ...
                    "confidence": 0.95,
                    "bbox": [[10, 10], [w - 10, 10], [w - 10, 30], [10, 30]],
                },
                {
                    "text": "This is a test OCR result.",
                    "confidence": 0.92,
                    "bbox": [[10, 40], [w - 10, 40], [w - 10, 60], [10, 60]],
                },
            ],
            "confidence": 0.93,
            "layout": {
