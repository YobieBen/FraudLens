...
# Metrics
request_count = Counter('fraudlens_requests_total', 'Total requests', ['method', 'endpoint', 'status'])
request_duration = Histogram('fraudlens_request_duration_seconds', 'Request duration', ['method', 'endpoint'])
...
class ProductionServer:
    ...
    def _setup_middleware(self):
        ...
        self.app.add_middleware(
            ...
            allowed_hosts=["*.fraudlens.com", "localhost", "127.0.0.1"]
        )
