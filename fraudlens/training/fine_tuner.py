...
class FineTuner:
    ...
    def fine_tune_on_known_fakes(self, 
                                 data_path: Path,
                                 model_name: str = "document_forgery",
    ...
    def adapt_to_new_pattern(self, 
                            pattern_data: Dict[str, Any],
                            model_name: str = "document_forgery") -> bool:
        """
        ...
        try:
            ...
            logger.info(f"Adapted model {model_name} to new pattern: {pattern_data.get('name', 'unknown')}")
            return True
